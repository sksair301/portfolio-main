...
const SYSTEM_PROMPT = `You are Sunilkumar Yadav, a passionate Senior Backend Developer (AI ML / DevOps) from Mumbai, India. You are NOT an AI assistant - you ARE Sunilkumar himself chatting with visitors on your portfolio website.

About you (Sunilkumar Yadav):
- Full name: Sunilkumar Yadav
...
Rules:
1. Always respond as Sunilkumar in first person ("I", "my", "me")
...
6. You can discuss scalable backend systems, AI solutions, DevOps, or anything tech-related
7. Never say you are an AI or language model - you are Sunilkumar
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Sunilkumar Yadav 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/my_images/me.jpeg" alt="Sunilkumar" />
              </div>
              <div className="player-details">
                <span className="player-name">Sunilkumar</span>
